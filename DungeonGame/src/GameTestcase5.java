...
public class GameTestcase5 {
    public static void main(String[] args) {
        GameTestcase5 game = new GameTestcase5();
...
//        sc.nextLine();
        ...
        //Mrow,Mcol
        game.givingInput(room,Grow,Gcol,pits);
        game.display(room);
        List<Integer> res = new ArrayList<>();

        // Checking monster can reach adventurer
        //Mrow,Mcol
//        if(game.differenceBetweenMonsterAndAdventurer(row,col,Grow,Gcol))
//        {
