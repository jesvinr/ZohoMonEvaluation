...
public class GameTestcase4 {
    public static void main(String[] args) {
        GameTestcase4 game = new GameTestcase4();
...
//        sc.nextLine();
        ...
        // ,pits
        game.givingInput(room,Grow,Gcol,Mrow,Mcol,tRow,tCol);
        game.display(room);
    ...
    // ,List<List<Integer>> pits
    void givingInput(char[][] room,int Grow,int Gcol,
